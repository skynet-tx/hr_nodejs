...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 11 2013 г., 14:34
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `position` varchar(45) NOT NULL DEFAULT 'Manager',
  `filial` varchar(45) NOT NULL DEFAULT 'Main',
...
INSERT INTO `users` (`id`, `name`, `email`, `position`, `filial`, `role`, `salt`, `hash`, `created`) VALUES
...
(2, 'manager', 'manager@adm.com', 'Administrator', 'Main', 'manager', '', '1d0258c2440a8d19e716292b231e3190', '2013-10-30 10:00:00');
